...
public class AnswerDialog extends RoundDialog {
	private ContactRequest req;
	private RoundButton ok;
	private RoundButton cancel;
	private boolean sel;

	public AnswerDialog(ContactRequest req) {
		this.req = req;
		layComponents();
		setListeners();
	}
	...
	private void layComponents() {
		setTitle(new JLabel("好友请求：" + req.getRequester().getUsername()));
		...
		msg.add(new JLabel("验证消息:" + req.getMessage()));
